...
_G.packer_plugins = {
  ["barbecue.nvim"] = {
    ...
    loaded = true,
    path = "/home/yang/.local/share/nvim/site/pack/packer/start/barbecue.nvim",
  ...
  nightfly = {
    loaded = true,
    path = "/home/yang/.local/share/nvim/site/pack/packer/start/nightfly",
    url = "https://github.com/bluz71/vim-nightfly-colors"
  },
  ["nvim-navic"] = {
    loaded = true,
    path = "/home/yang/.local/share/nvim/site/pack/packer/start/nvim-navic",
